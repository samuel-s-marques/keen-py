...
| ------------------ | ------------------------------ | ----------------------------------- | -------- | ---------------------- |
| `TARGET`           | The email address to lookup.   | None                                | True     | `email,phone,username` |
| `TYPE`             | The type of the target.        | auto (username, email, phone, auto) | False    | None                   |
...
- If the target is an email address, it will check **HaveIBeenPwned**, **LeakCheck**, **BreachVIP**, **DeHashed**, and **ProxyNova**.
