...
export const nodeValueGroup = document.getElementById("node-value-group");
export const nodeMediaFileGroup = document.getElementById("node-media-file-group");
export const nodeMediaFileInput = document.getElementById("node-media-file");
